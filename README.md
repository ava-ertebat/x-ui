...
1. First download the latest compressed package from https://github.com/ava-ertebat/x-ui/releases, generally choose `amd64` architecture
...
[![Stargazers over time](https://github.com/ava-ertebat)
